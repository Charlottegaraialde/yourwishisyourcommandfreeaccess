      ...
      <div className="w-full max-w-3xl mx-auto text-center px-2">
        <div className="w-full mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-gold-400 text-lg md:text-xl font-bold">
            ...
            <a 
              ...
              className="px-3 py-2 bg-gold-400 text-navy-950 rounded hover:bg-gold-300 transition-colors text-lg font-bold whitespace-nowrap"
              target="_blank"
