    ...
    <section id="home" className="pt-24 sm:pt-32 md:pt-48 pb-0 relative">
      <div className="w-full mx-auto px-2 sm:px-4 md:px-2 py-12 md:py-16">
        <div className="w-full max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-8 sm:mb-10 leading-tight sm:leading-[1.1] md:leading-[1.1] px-2 sm:px-4 md:px-0">
          ...
          <p className="text-2xl md:text-3xl mb-12 max-w-2xl mx-auto font-serif font-bold text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mx-auto w-auto mb-12">
            <a 
              ...
              className="w-full max-w-[280px] sm:w-auto px-8 py-4 bg-gold-400 text-navy-950 rounded hover:bg-gold-300 transition-colors text-xl sm:text-2xl font-extrabold font-serif text-center border-2 border-gold-400"
              target="_blank"
            ...
            <a 
              href="#knowledge" 
              className="w-full max-w-[280px] sm:w-auto px-8 py-4 border-2 border-gold-400 text-gold-400 rounded hover:bg-gold-400/10 transition-all text-xl sm:text-2xl font-extrabold font-serif text-center"
            >
              Learn More
            </a>
          </div>
