    ...
    <section id="home" className="pt-24 sm:pt-32 md:pt-48 pb-0 relative">
      <div className="w-full mx-auto px-2 sm:px-4 md:px-2 py-8 md:py-12">
        <div className="w-full max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-4 sm:mb-6 leading-tight sm:leading-[1.1] md:leading-[1.1] px-2 sm:px-4 md:px-0">
            Discover the Hidden Secrets<br />
            <span>of <span className="text-gold-400">The law of attraction</span></span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <div className="flex flex-col items-center w-full max-w-xs sm:w-auto">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-gold-400 flex items-center justify-center animate-bounce mx-auto my-2">
                <svg 
