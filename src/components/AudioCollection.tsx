...
export const AudioCollection: React.FC = () => {
  return (
    <section id="audio-collection" className="py-20 bg-navy-900">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <div className="inline-block mb-4">
            <span className="text-xs uppercase tracking-widest text-gold-400">Exclusive Collection</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto bg-navy-800 border border-gold-800/50 rounded-lg p-8 md:p-12 text-center">
          <h3 className="text-2xl md:text-3xl font-bold mb-4">Unlock All 14 Audio Revelations <span className="text-gold-400">For Free</span></h3>
          <p className="text-lg mb-8 text-gray-300">
            Use the exclusive promo code below to get instant access to all 14 audios, valued at $500.
          </p>
          
          <div className="bg-gold-400/10 border-2 border-dashed border-gold-400 rounded-md p-4 md:p-6 mb-8 max-w-sm mx-auto">
