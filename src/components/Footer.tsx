...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-navy-950 border-t border-gold-800/30 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Revealing the secrets of manifestation and success that has been hidden from the public, for centuries, by the elite class.
            </p>
          </div>
        ...
        <div className="border-t border-gold-800/30 mt-12 pt-8 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Your Wish Is Your Command. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
