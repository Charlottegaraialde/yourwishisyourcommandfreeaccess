      ...
      <div className="w-full mx-auto px-4 text-center text-xl md:text-2xl">
        <div className="flex flex-wrap justify-center -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4">
            <h4 className="text-2xl md:text-3xl font-semibold text-gold-200 mb-4">Quick Links</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={item.name}>
                  <a 
                    href={item.link} 
                    className="text-gray-400 hover:text-gold-400 transition-colors text-lg md:text-xl font-bold"
        ...
        <div className="border-t border-gold-800/30 mt-12 pt-8 text-center">
          <p className="text-gray-500 text-lg md:text-xl font-bold">
